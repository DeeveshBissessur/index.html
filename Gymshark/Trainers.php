...
<html lang="en">
  <head>
    ...
    <style>
      ...
      div{
            background-color: rgba(207, 239, 245, 0.988);
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img src="./trainer 1.jpg" class="d-block w-100" alt="Lucas">
            <h5>Lucas Sheehan</h5>
            <p>
              London based Lucas believes everyone has the right to love their body. He takes an approach which is educated, experienced and honest about what’s actually important. No more confusion or chasing shiny objects. Lucas offers one to one and online coaching to help clients to get into the best shape of their lives, and - like his clients - he’s really motivated by that transformational before and after.
